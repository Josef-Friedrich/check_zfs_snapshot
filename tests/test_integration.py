...
def test_first_ok_zpool() -> None:
    ...
    assert (
        "ZFS_SNAPSHOT OK | 'ok_dataset: last snapshot (timespan)'=13528s;86400;259200"
        == result.first_line
    )
...
def test_all_datasets() -> None:
    ...
    assert result.stdout
    assert (
        "ZFS_SNAPSHOT CRITICAL - Last snapshot for dataset 'critical_dataset' was created on 1970-01-01T00:00:00 | 'critical_dataset: last snapshot (timespan)'=1502928065s;86400;259200 'ok_dataset: last snapshot (timespan)'=13528s;86400;259200 'warning_dataset: last snapshot (timespan)'=93601s;86400;259200"
        == result.first_line
    )
